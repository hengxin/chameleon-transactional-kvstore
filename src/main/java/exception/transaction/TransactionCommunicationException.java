...
/**
 * {@link TransactionCommunicationException} indicates errors which occurred during communications, 
 * including both the communication between clients and the master via RMI and that between
