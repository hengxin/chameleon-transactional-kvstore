 ...
 * by holding an {@link IMessageProducer}; therefore, an {@link AbstractMaster} is able
...
public abstract class AbstractMaster extends AbstractSite {
	 ...
	 */
	public AbstractMaster(IContext context, @Nullable IMessageProducer messenger) {
		super(context);
