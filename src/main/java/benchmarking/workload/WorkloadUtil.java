...
public class WorkloadUtil {
    ...
    public enum WorkloadParams {
        ...
        MEAN_TIME_INTER_TRANSACTIONS("meanTimeInterTransactions", "1000"),
        MIN_TIME_INTER_TRANSACTIONS("minTimeInterTransactions", "1000"),
        MAX_TIME_INTER_TRANSACTIONS("maxTimeInterTransactions", "2000"),
        K1BV("k1", "1"),
        K2FV("k2", "0"),
        K3SV("k3", "1"),
        RVSI("rvsi", "(1,0,1)");
