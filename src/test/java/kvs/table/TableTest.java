...
{
	private Table master_table = new Table(); // using {@link MultiTimestampedCellsStore}
	private Table slave_table = new Table(); // using {@link SingleTimestampedCellStore}
	...
	public void setUp() throws Exception
	{
		...
		ITimestampedCell ts_cell_0L = new TimestampedCell(Timestamp.TIMESTAMP_INIT, Cell.CELL_INIT);
		ITimestampedCell ts_cell_2L = new TimestampedCell(new Timestamp(2L), new Cell("TS_CELL_2L"));
		ITimestampedCell ts_cell_4L = new TimestampedCell(new Timestamp(4L), new Cell("TS_CELL_4L"));
	...
	public void testGetTimestampedCellRowColumn()
	{
		...
		assertEquals("The latest data in the slave table should be TS_CELL_4L", ts_cell_4L, ts_cell_slave);
	}
	...
	public void testGetTimestampedCellRowColumnTimestamp()
	{
		...
		ITimestampedCell ts_cell_slave = this.master_table.getTimestampedCell(new Row("R1"), new Column("C1"), new Timestamp(3L));
		assertEquals("It should obtain the latest data TS_CELL_4L in the slave table.", ts_cell_4L, ts_cell_slave);
	}
